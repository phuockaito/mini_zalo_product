    ...
    return (
        <>
            ...
            <div className="p-4 relative h-full grid">
                <div className="flex items-center justify-between h-7 overflow-hidden gap-2">
                    <div
                ...
                <div className="grid place-content-center place-self-end w-full gap-8">
                    <div
                        className={clsx("w-[280px] h-[280px] m-auto", playing_audio && "spin-2s")}
                    >
                        <img
                    ...
                    <div className="flex items-center justify-center flex-col overflow-hidden truncate">
                        <p className="text-white text-xl font-semibold text-center truncate">{music.name_music}</p>
